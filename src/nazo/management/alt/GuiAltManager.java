...
import nazo.management.alt.Altening.TheAlteningAuthentication;
import nazo.management.alt.Altening.api.AlteningGUI;
import nazo.management.alt.Altening.api.AlteningServiceType;
  ...
  extends GuiScreen
{
  ...
  public void actionPerformed(GuiButton button) throws IOException {
    ...
    switch (button.id) {
      ...
      case 8:
        ...
        this.mc.displayGuiScreen((GuiScreen)new AlteningGUI(this));
        break;
    } 
  }
  ...
  public void drawScreen(int par1, int par2, float par3) {
    ...
    if (this.serviceSwitcher.getService() == AlteningServiceType.THEALTENING) {
      this.mc.fontRendererObj.drawString("Status:TheAlting", 10, 20, -107374183);
    } else {
    ...
    Gui.drawRect(50.0D, 33.0D, (width - 50), (height - 50), -16777216);
    GL11.glPushMatrix();
    ...
    for (Alt alt2 : AltManager.registry) {
      ...
      if (alt2 == this.selectedAlt) {
        if (isMouseOverAlt(par1, par2, y2 - this.offset) && Mouse.isButtonDown(0)) {
          Gui.drawRect(52.0D, (y2 - this.offset - 4), (width - 52), (y2 - this.offset + 20), -2142943931);
        } else if (isMouseOverAlt(par1, par2, y2 - this.offset)) {
          Gui.drawRect(52.0D, (y2 - this.offset - 4), (width - 52), (y2 - this.offset + 20), -2142088622);
        } else {
          Gui.drawRect(52.0D, (y2 - this.offset - 4), (width - 52), (y2 - this.offset + 20), -2144259791);
        } 
      } else if (isMouseOverAlt(par1, par2, y2 - this.offset) && Mouse.isButtonDown(0)) {
        Gui.drawRect(52.0D, (y2 - this.offset - 4), (width - 52), (y2 - this.offset + 20), 1);
      } else if (isMouseOverAlt(par1, par2, y2 - this.offset)) {
        Gui.drawRect(52.0D, (y2 - this.offset - 4), (width - 52), (y2 - this.offset + 20), 1);
      } 
